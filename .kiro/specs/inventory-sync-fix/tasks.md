...
- [x] 11. Интеграция улучшенных API endpoints Ozon

  - [x] 11.1 Реализовать новый метод получения остатков через v4 API

    - Заменить старый report-based подход на прямые запросы к POST /v4/product/info/stocks
    - Реализовать корректную обработку пагинации через cursor
    - Добавить поддержку фильтрации по offer_id и visibility
    - Обработать все типы остатков: present, reserved, fbo, fbs, realFbs
    - _Requirements: 1.1, 1.2_

  - [x] 11.2 Добавить получение информации о складах

    - Реализовать метод для запроса списка складов через POST /v1/warehouse/fbo/list
    - Создать маппинг warehouse_id -> warehouse_name для корректного отображения
    - Добавить кэширование информации о складах (обновление раз в день)
    - Интегрировать данные складов с основными остатками
    - _Requirements: 1.1, 4.1_

  - [x] 11.3 Интегрировать аналитический API для дополнительной информации

    - Добавить запросы к POST /v2/analytics/stock_on_warehouses для детальной аналитики
    - Использовать аналитические данные для валидации основных остатков
    - Реализовать сравнение данных между основным и аналитическим API
    - Добавить алерты при значительных расхождениях данных
    - _Requirements: 4.1, 4.2, 4.3_

  - [x] 11.4 Обновить обработку ошибок для новых endpoints

    - Адаптировать retry логику под специфику новых API endpoints
    - Добавить обработку специфических ошибок v4 API
    - Реализовать fallback на старые методы при недоступности новых
    - Обновить логирование для отслеживания использования разных endpoints
    - _Requirements: 2.1, 2.2, 2.3_
