...
1. **Проверьте подключение к БД** - убедитесь, что данные в `metrics_daily` актуальны
2. **Проверьте логи** - включите логирование для отладки
3. **Валидируйте данные** - убедитесь, что расчеты корректны
4. **Оптимизируйте запросы** - используйте индексы для больших объемов данных
