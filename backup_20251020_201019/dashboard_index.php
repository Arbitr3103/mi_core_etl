    ...
    <div class="container">
        ...
        <div class="dashboards">
            ...
            <div class="dashboard-card">
                <div class="new-badge">NEW</div>
                <span class="dashboard-icon">🌍</span>
                <h3 class="dashboard-title">Региональная аналитика</h3>
                <p class="dashboard-description">
                    Аналитика продаж бренда ЭТОНОВО по регионам России и маркетплейсам
                </p>
                <ul class="dashboard-features">
                    <li>Сравнение Ozon vs Wildberries</li>
                    <li>Топ товары по маркетплейсам</li>
                    <li>Динамика продаж по регионам</li>
                    <li>Интеграция с Ozon API</li>
                    <li>Детальная региональная разбивка</li>
                </ul>
                <a href="html/regional-dashboard/" class="dashboard-link">
                    Открыть аналитику
                </a>
                <div class="status status-new">Новая версия</div>
            </div>
