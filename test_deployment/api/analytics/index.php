...
try {
    ...
    switch (true) {
        ...
        case $pathSegments[0] === 'marketplace-share':
            // Marketplace share endpoint
            require_once __DIR__ . '/endpoints/marketplace-share.php';
            handleMarketplaceShare();
            break;
            
        case $pathSegments[0] === 'dashboard-summary':
            // Dashboard summary endpoint
            require_once __DIR__ . '/endpoints/dashboard-summary.php';
...
function handleApiRoot() {
    $response = [
        ...
        'endpoints' => [
            ...
            'marketplace-share' => [
                'method' => 'GET',
                'description' => 'Get marketplace share statistics and performance metrics',
                'parameters' => ['date_from', 'date_to']
            ],
            'dashboard-summary' => [
                'method' => 'GET',
                'description' => 'Get aggregated KPI data for dashboard overview',
                'parameters' => ['date_from', 'date_to', 'marketplace']
            ],
            'regions' => [
                'method' => 'GET',
                'description' => 'Get regional sales data and statistics',
                'parameters' => ['date_from', 'date_to', 'region_code', 'limit']
            ],
            'health' => [
                'method' => 'GET',
