...
class OzonAnalyticsAPI {
    ...
    public function getCampaignData($dateFrom, $dateTo, $campaignId = null) {
        ...
        // Временно возвращаем mock данные для демонстрации
        // TODO: Реализовать реальный запрос к Ozon API когда будут правильные метрики
        
        $mockData = [
            [
                'campaign_id' => 'camp_001',
                'campaign_name' => 'Рекламная кампания #1',
                'date_from' => $dateFrom,
                'date_to' => $dateTo,
                'impressions' => 15420,
                'clicks' => 892,
            ...
            [
                ...
                'campaign_name' => 'Рекламная кампания #2',
                'date_from' => $dateFrom,
                'date_to' => $dateTo,
                'impressions' => 8930,
                'clicks' => 456,
            ...
            [
                ...
                'campaign_name' => 'Рекламная кампания #3', 
                'date_from' => $dateFrom,
                'date_to' => $dateTo,
                'impressions' => 12100,
                'clicks' => 678,
        ...
        // Фильтруем по campaign_id если указан
        if ($campaignId) {
            $mockData = array_filter($mockData, function($campaign) use ($campaignId) {
                return $campaign['campaign_id'] === $campaignId;
            });
        }
        
        // Сохраняем в БД если подключение доступно
        $this->saveCampaignDataToDatabase($mockData);
